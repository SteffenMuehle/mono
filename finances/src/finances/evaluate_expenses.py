...
elizabeth_contributions = [val["amount"] for key, val in io["transaction"].items() if key.startswith("Elizabeth")]
print("\n| Transaction | Amount |")
print("|-------------|--------|")
...
print(
    f"- Monthly Out: {monthly_out}   --> Setting target in giro to {TARGET_NUMBER_OF_MONTHLY_COSTS_IN_GIRO} monthly expenses, which is {target_in_giro}"
)
